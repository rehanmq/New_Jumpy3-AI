...
"""
import sys
from jumpy3_utils import read_board, write_board, alphabeta, static_evaluation
...
def main():
    ...
    eval_value, best_move = alphabeta(board, depth, -float('inf'), float('inf'), True, static_evaluation, positions_evaluated)
